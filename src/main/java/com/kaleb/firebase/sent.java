 ...
 */
public class sent extends Fragment implements RemoveClickListner {
    TextView t;
    ...
    public void OnRemoveClick(int index) {
        d=f.getReference("k/Transaction/Sent/"+list.get(index));
        d.removeValue();
        list.remove(index);
        myList.remove(index);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecyclerView = (RecyclerView)root.findViewById(R.id.recyclesent);
        ...
        d=f.getReference("k/Transaction/Sent");
